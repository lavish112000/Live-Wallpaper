...
Filename: "{tmp}\windowsdesktop-runtime-9.0.8-win-x64.exe"; Parameters: /install /quiet /norestart; Check: NetCoreNeedsInstall('9.0.8');  StatusMsg: Installing .NET Desktop Runtime 9.0.8...
