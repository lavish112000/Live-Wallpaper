...
namespace Lively.Common
{
    public static class Languages
    {
        private readonly static LanguageModel[] supportedLanguages = [
            ...
            new LanguageModel("Español (España)", "es-ES"), // Spanish
            ...
            new LanguageModel("Français", "fr-FR"), // French
            new LanguageModel("Deutsch", "de-DE"), // German
            new LanguageModel("Polski", "pl-PL"), // Polish
            new LanguageModel("Português (Portugal)", "pt-PT"),// Portuguese (Portugal)
            new LanguageModel("Português (Brasil)", "pt-BR"), // Portuguese (Brazil)
            ...
            new LanguageModel("Српски језик", "sr-Latn"), // Serbian (Latin)
            ...
            new LanguageModel("Lietuvių", "lt-LT"), //Lithuanian
